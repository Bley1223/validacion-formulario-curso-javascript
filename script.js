const submitFuction = (event) => {
    if (!validarFormulario()){
        ...
        alert(
            ...
            'Apellidp: ' + document.getElementById('apellido').value + '\n'+
...
document.getElementById('formulario').addEventListener('submit', submitFuction) //escucha el envio del formulario
...
function validarFormulario(){
    ...
    if(edad.value < 18){
        mostrarError(errorEdad, ' ¡Debes ser mayor de 18 años para resgistrarte!')
        validacionCorrecta = false
    }else{
